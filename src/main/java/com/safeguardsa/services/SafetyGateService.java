 ...
 *
 * Scans EVERY incoming chat message BEFORE calling Gemini. If an emergency
 * keyword is detected, Gemini is NEVER called. Returns a SafetyCheckResult with
 * category, keyword, and emergency contacts.
 *
...
public class SafetyGateService {
    ...
    public static class EmergencyResponse {
        ...
        public boolean isShowCrisisResources() {
