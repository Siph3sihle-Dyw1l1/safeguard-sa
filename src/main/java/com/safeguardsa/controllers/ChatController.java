 ...
 * POST /chat/ask  → processes health question through Safety Gate + RAG + Gemini
 *
...
public class ChatController {
    ...
    /**
     * Processes a student health question.
     *
     * Request:  { "message": "What are symptoms of dehydration?" }
     * Response: { "emergency": false, "response": "...", "sources": [...] }
     *   or
     * Response: { "emergency": true, "category": "...", "title": "...",
     *             "emergencyMessage": "...", "contacts": [...] }
     */
